...
public class MusicAdapter extends RecyclerView.Adapter<MusicHolder> implements View.OnClickListener{
    ...
    public MusicHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.card_music_main, parent, false);
        MusicHolder holder = new MusicHolder(v);
...
class MusicHolder extends RecyclerView.ViewHolder{
    ...
    public MusicHolder(View itemView) {
        super(itemView);
        name = (TextView) itemView.findViewById(R.id.music_main_name);
        desc = (TextView) itemView.findViewById(R.id.music_main_description);
        image = (ImageView) itemView.findViewById(R.id.music_main_image);
        favBtn = (ImageView) itemView.findViewById(R.id.music_main_favorite);
    }
}